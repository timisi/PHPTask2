...
$full_name = strlen($_POST['first_name']) > 2 ? $_POST['first_name'] : $errorCount++;
$last_name = strlen($_POST['last_name']) > 2 ? $_POST['last_name'] : $errorCount++;
$gender = $_POST['gender'] != "" ? $_POST['gender'] : $errorCount++;
$email = $_POST['email'] != "" ? $_POST['email'] : $errorCount++;
$password = $_POST['password'] != "" ? $_POST['password'] : $errorCount++;
$designation = $_POST['designation'] != "" ? $_POST['designation'] : $errorCount++;
$department = $_POST['courses']  != "" ? $_POST['courses'] : $errorCount++;
...
if ($errorCount > 0) {
    ...
    if (empty($_POST["first_name"])) {
        ...
        $full_name = test_input($_POST["first_name"]);
    ...
    if (empty($_POST["last_name"])) {
        ...
        $full_name = test_input($_POST["last_name"]);
        //check if name has less than 2 characters
        if (strlen($full_name) < 2) {

...
$student_firstname = $_SESSION['first_name'];
$student_lastname = $_SESSION['last_name'];
...
if ($errorCount > 0) {
    ...
    file_put_contents("../db/appointments/". $student_firstname . $appointment_date .".json", json_encode($appointmentObject));
